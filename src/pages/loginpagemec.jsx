...
const LoginPageMec = () => {
  ...
  const handleLogin = (e) => {
    ...
    // ✅ Save authentication
    localStorage.setItem("isAuthenticatedMec", "true");

    // ✅ Redirect: go back to requested path (Maintenance) or homepage
    ...
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 bg-card/90 backdrop-blur-md rounded-2xl shadow-industrial p-8 w-full max-w-md">
        ...
        <p className="text-center mb-6 text-slate-200">
          Connectez-vous pour accéder au centre de maintenance.
        </p>
