...
const MachineMarketplace = () => {
  ...
  const mockProducts = [
    {
      id: 1,
      name: "Brother DB2-B755-3 Machine Industrielle",
      description: "Machine à coudre industrielle haute vitesse pour couture générale avec coupe-fil automatique et système de lubrification optimisé.",
    ...
    {
      id: 2,
      name: "Juki DDL-8700 Surjeteuse Professionnelle",
      description: "Surjeteuse industrielle 4 fils avec système de coupe différentielle et contrôle pneumatique pour finitions parfaites.",
    ...
    {
      id: 3,
      name: "Singer 191D-30 Machine à Broder Numérique",
      description: "Machine à broder industrielle avec écran tactile 10 pouces, connectivité WiFi et bibliothèque de 500 motifs intégrés.",
    ...
    {
      id: 4,
      name: "Pfaff 1245-706/47 Recouvreuse Cuir",
      description: "Machine recouvreuse spécialisée pour cuir et matériaux épais avec système d\'entraînement triple et pied presseur renforcé.",
      image: "https://images.pexels.com/photos/7148621/pexels-photo-7148621.jpeg?w=600&h=400&fit=crop",
      price: 15200,
      monthlyPayment: 422,
      type: "recouvreuse",
      brand: "Pfaff",
    ...
    {
      id: 5,
      name: "Janome MB-4S Boutonnière Automatique",
      description: "Machine spécialisée boutonnière avec système de reconnaissance automatique et 12 types de boutonnières préprogrammées.",
      image: "https://images.pixabay.com/photo/2021/08/26/16/58/sewing-machine-6577841_1280.jpg?w=600&h=400&fit=crop",
      price: 6800,
      monthlyPayment: 189,
      type: "boutonniere",
      brand: "Janome",
    ...
    {
      id: 6,
      name: "Brother PR-1055X Multi-Aiguilles Broderie",
      description: "Station de broderie professionnelle 10 aiguilles avec cadre géant 360x200mm et logiciel de création intégré.",
  ...
  useEffect(() => {
    ...
    if (filters?.brand?.length > 0) {
      filtered = filtered?.filter(product => filters?.brand?.includes(product?.brand?.toLowerCase()));
    }
